      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-12 gap-12 lg:gap-8 mb-16">
          ...
          <div className="md:col-span-4 lg:col-span-5 flex flex-col space-y-6">
            <div className="relative w-fit">
              ...
              <div className="relative bg-background px-4 py-2 rounded-lg border border-white/10">
                <span className="text-3xl font-extrabold text-gradient">DiCode</span>
              </div>
            </div>
            <p className="text-gray-500 text-sm leading-relaxed max-w-sm">
              Agensi digital modern untuk kebutuhan website dan undangan digital.
              Wujudkan ide digital lebih nyata bersama DiCode.
            </p>
            <div className="flex gap-4">
              {/* Instagram */}
              <a
                href="https://instagram.com/dicode.id"
                target="_blank"
                rel="noreferrer"
              ...
              {/* TikTok */}
              <a
                href="https://tiktok.com/@dicode.id"
                target="_blank"
                rel="noreferrer"
                className="w-10 h-10 rounded-full bg-white/5 border border-white/10 flex items-center justify-center text-gray-500 hover:text-primary hover:-translate-y-1 hover:shadow-lg hover:shadow-primary/20 transition-all duration-500"
              >
          ...
          <div className="md:col-span-4 lg:col-span-3">
            ...
            <ul className="space-y-4">
              <li>
                <a href="mailto:dicode.indonesia@gmail.com" className="flex items-start space-x-3 text-gray-500 hover:text-accent text-sm transition-colors">
                  <span className="material-symbols-outlined text-[20px]">mail</span>
                  <span>dicode.indonesia@gmail.com</span>
                </a>
              </li>
              <li>
        ...
        <div className="border-t border-white/5 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-gray-600 text-sm">© 2026 DiCode. All rights reserved.</p>

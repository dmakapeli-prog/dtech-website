...
const templates = [
  { id: 1, name: "Corporate Blue", category: "Website", image: "/assets/template-1.png" },
  { id: 2, name: "Modern Landing", category: "Website", image: "/assets/template-2.png" },
  { id: 3, name: "Elegant Gold", category: "Undangan Digital", image: "/assets/template-3.png" },
  { id: 4, name: "Formal Black", category: "Undangan Digital", image: "/assets/template-4.png" }
];

const categories = ["Semua", "Website", "Undangan Digital"];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
          {filtered.map((template) => (
            ...
            >
              {/* Preview Area */}
              <div className="relative h-56 bg-[#0a0a1a] flex items-center justify-center overflow-hidden border-b border-white/10">
                <Image src={template.image} alt={template.name} fill className="object-cover group-hover:scale-105 transition-transform duration-700" />
